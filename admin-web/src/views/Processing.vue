...
const paymentChannels = computed(() => app.paymentChannels.filter(channel => Number(channel.status) === 1 && String(channel.channel_code).toUpperCase() !== 'COMBINATION'))
